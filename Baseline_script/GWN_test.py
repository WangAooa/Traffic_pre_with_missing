...
save_path = '/home/wangao/Traffic_prediction_with_missing_value'
...
def test_model(net, test_dataset, args):
    ...
    with torch.no_grad():
        ...
        with open(save_path +"/result/missing_rate_{}/{}/{}/{}/test_result.txt".format(
...
def train(net, train_dataset, test_dataset,args):
    ...
    Path(save_path + "/result/missing_rate_{}/{}/{}/{}".format(args.missing_rate, args.dataset_type,
                                                                 args.model_type, args.im_model_type)).mkdir(parents=True, exist_ok=True)

    with open(save_path+'/result/missing_rate_{}/{}/{}/{}/result.csv'.format(
    ...
    earlystop = EarlyStopping(patience= 7,verbose=True,
                              path=save_path +'/result/missing_rate_{}/{}/{}/{}/model.pt'.format(
...
def main():
    ...
    parser.add_argument("--model_type", type=str, default='Graph_Wavenet_newgenerated_dataset')
    ...
    train_data_path = args.root_path + '/{}/save/{}/{}_train_pretask.npz'.format(args.dataset_type,args.missing_rate,args.im_model_type)
    test_data_path = args.root_path +'/{}/save/{}/{}_test_pretask.npz'.format(args.dataset_type,args.missing_rate,args.im_model_type)

    adj = np.load('data/wangao' +args.adj_path)
    ...
    model = Model(device, num_nodes=args.num_node, supports=[adj], in_dim=args.input_dim, out_dim=args.horrizon)
    ...
    test_data_path = args.root_path +'/{}/save/{}/{}_val_pretask.npz'.format(args.dataset_type,args.missing_rate,args.im_model_type)
    test_dataset = np.load(test_data_path)
