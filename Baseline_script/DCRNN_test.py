...
from Baseline_model.Prediction_model.DCRNN import STGRU as Model
...
def main():
    ...
    parser.add_argument("--horrizon", type=int, default=3)
    ...
    parser.add_argument("--dataset_type", type=str, default="PEMS(M)_NR_3")                                      #
    parser.add_argument("--model_type", type=str, default='DCRNN')
    parser.add_argument("--root_path", type=str, default="/data/wangao")
    parser.add_argument("--im_model_type", type=str, default='N')
    ...
    model = Model(adj=adj, num_node=args.num_node, horrizon=args.horrizon)
