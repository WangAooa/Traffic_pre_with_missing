...
from Baseline_model.Prediction_model.MTGNN import gtnet as Model
...
def main():
    ...
    parser.add_argument("--model_type", type=str, default='MTGNN')
    parser.add_argument("--root_path", type=str, default="/data/wangao")
    parser.add_argument("--im_model_type", type=str, default='BTMF')
    ...
    model = Model(gcn_true=True, buildA_true=True, gcn_depth=2, num_nodes=args.num_node,device=device,predefined_A=adj)
