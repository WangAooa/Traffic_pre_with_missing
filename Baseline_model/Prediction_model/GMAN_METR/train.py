...
parser.add_argument('--decay_epoch', type=int, default = 5,
                    help = 'decay epoch')
parser.add_argument('--traffic_file', default = '/home/wangao/Traffic_prediction_with_missing_value/PEMS(M)/dataset/V_brits_4.npy',             #
                    help = 'traffic file')
parser.add_argument('--full_traffic_file', default = '/home/wangao/Traffic_prediction_with_missing_value/PEMS(M)/dataset/V_228.csv',             #
                    help = 'traffic file')

parser.add_argument('--SE_file', default = "/home/wangao/Traffic_prediction_with_missing_value/Baseline_model/Prediction_model/GMAN_PEMS(M)/data/SE(PEMS).txt",             #
                    help = 'spatial emebdding file')
parser.add_argument('--model_file', default = "/home/wangao/Traffic_prediction_with_missing_value/result/missing_rate_4/PEMS(M)/GMAN/BTMF_r10/model",            #
                    help = 'save the model to disk')
parser.add_argument('--log_file', default = "/home/wangao/Traffic_prediction_with_missing_value/result/missing_rate_4/PEMS(M)/GMAN/BTMF_r10/log",               #
                    help = 'log file')
parser.add_argument('--save_dir', default = "/home/wangao/Traffic_prediction_with_missing_value/result/missing_rate_4/PEMS(M)/GMAN/BTMF_r10",               #
                    help = 'log file')
...
##############################################
# if int(args.model_file.split('/')[4][13]) > 5:
#     os._exit(0)
#################################################
...
for batch_idx in range(num_batch):
    ...
    print(pred_batch[:,-1,0])
    trainPred.append(pred_batch[:,-1,0])

trainPred = np.array(trainPred[:len(trainPred)-1])
print(trainPred.shape)
np.save('./GMAN_PEMS(M)_NR_8.npy', trainPred.reshape(-1))
